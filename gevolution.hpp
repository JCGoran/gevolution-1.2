...
void projection_T00_project_RSD(Particles<part, part_info, part_dataType> * pcls, const cosmology cosmo, Field<Real> * T00, double fourpiG, double a = 1., Field<Real> * phi = NULL, double coeff = 1.)//change:passed csomlogy params
{
	if (T00->lattice().halo() == 0)
	{
		cout<< "projection_T00_project: target field needs halo > 0" << endl;
