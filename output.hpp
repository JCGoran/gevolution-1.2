...
)
{
	...
	int * occupation;
	//changed
	kbin = (Real *) malloc(sim.numbins * sizeof(Real)*MU_BINS);
	power = (Real *) malloc(sim.numbins * sizeof(Real)*MU_BINS);
	kscatter = (Real *) malloc(sim.numbins * sizeof(Real)*MU_BINS);
	pscatter = (Real *) malloc(sim.numbins * sizeof(Real)*MU_BINS);
	occupation = (int *) malloc(sim.numbins * sizeof(int)*MU_BINS);
